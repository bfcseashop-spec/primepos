export const en = {
  ...
  patientMonitor: {
    ...
    description: "Real-time vitals from MEDEX Smart View-Pro 12B and other monitors",
    ...
    realTimeDisconnected: "Reconnecting...",
  },
  opd: {
  ...
  registerPatient: {
    ...
    inputModeDob: "Date of Birth",
    inputModeAge: "Age",
    ageUnitDays: "Day(s)",
    ageUnitWeeks: "Week(s)",
    ageUnitMonths: "Month(s)",
    ageUnitYears: "Year(s)",
    gender: "Gender",
    male: "Male",
    female: "Female",
